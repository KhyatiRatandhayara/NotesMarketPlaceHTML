        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-10 logo-changepwd">
                    ...
                    <div id="logo" class="text-center" style="margin-top:70px">
                    ...
                    <form class="bg-white" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                ...
                                <img src="image/login/eye.png" toggle="#password-field-2" class="toggle-password" style="margin-top:-30px">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                ...
                                <img src="image/login/eye.png" toggle="#password-field-3" class="toggle-password" style="margin-top:-30px">
                            </div>
                        </div>

                        <button type="submit" class="btn btn-block btn-login" name="submit">SUBMIT</button>
                        <div class="correct">
                        <?php
                      if($changed_success){
