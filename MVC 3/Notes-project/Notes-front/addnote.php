...
if(isset($_GET['id'])){
    ...
    $query_published="UPDATE sellernote SET Status=4 where Seller_Note_id =$publish_id";
...
$radio = $_POST['radio'];
$sellprice = $_POST['sellprice'];
$display_default_img="../Members/default/N.jpg";    
        ...
        <section id="add-note">
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <textarea id="category-description" name="description" rows="4" cols="65" placeholder="Enter your description" required><?php echo "$description"?></textarea>
                </div>
            </div>
