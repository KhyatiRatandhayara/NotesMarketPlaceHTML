                        ...
                        <?php
                            while($row=mysqli_fetch_assoc($result_published)){
                             ...
                             $seller_note_id = $row['Seller_Note_id'];    
                                      ...
                                      echo "<td>$price</td>";
                                      echo "<td><a href='notedetails.php?id=$seller_note_id'><img src='image/Dashboard/eye.png' alt='view'></a>";
                                      echo "</tr>";
                                  }
                            ?>
                        </tbody>
