    ...
    <section id="forgot">
        <div class="container-fluid">
            <div class="row">
             ...
             $query ="select * from users where Email='$email' AND Userrole_id=2 AND IsActive=1";
...
try {
    ...
    $mail->Body ="Hello,<br>We have generated a new password for you Password: <b>$new_password</b><br>Regards,<br>Notes Marketplace";
