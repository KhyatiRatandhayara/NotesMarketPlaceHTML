...
echo $rating;
                ...
                $whereQuery = "";
                $query_fetch = "SELECT DISTINCT sellernote.Seller_Note_id,sellernote.Title,sellernote.Category,sellernote.NoteType,sellernote.UniversityName,sellernote.Course,sellernote.Country,sellernote.NumberofPages,sellernote.DisplayPicture,sellernote.PublishedDate FROM sellernote LEFT JOIN sellernotesreviews ON sellernote.Seller_Note_id=sellernotesreviews.Seller_note_id WHERE sellernote.IsActive=1 AND sellernote.Title LIKE '%$search%'";
...
$pagination_result = mysqli_query($conn,"SELECT COUNT(Seller_Note_id) FROM sellernote WHERE IsActive=1 AND Title LIKE '%$search%'");
       ...
       <section id="search-result">
        <div class="container">
            ...
            <div class="row">
                  ...
                  <?php 
                     echo "<a href='http://localhost/Notes-project/Notes-front/notedetails.php?id=$seller_note_id' style='text-decoration:none'>";   
