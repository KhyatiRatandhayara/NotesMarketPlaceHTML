...
if(in_array($filecheck1, $fileextstored1)){
    ...
    $valid_1 = false;
        ...
        $filetmp3 = $files3['tmp_name'];
         ...
         $fileextstored3 =array('jpg','png','jpeg');
    ...
    //upload-attatchment
        ...
        for($i=0;$i<$countfiles;$i++){
         ...
         $fetch_category = mysqli_query($conn,"SELECT Name FROM note_categories WHERE Category_id=$category");
         while($row=mysqli_fetch_assoc($fetch_category)){
              $category_name_fetch=$row['Name'];
         }
         
         $fetch_type = mysqli_query($conn,"SELECT Name FROM note_type WHERE Type_id=$type");
         while($row=mysqli_fetch_assoc($fetch_type)){
              $type_name_fetch=$row['Name'];
         }
         
         $fetch_country = mysqli_query($conn,"SELECT CountryName FROM countries WHERE Country_id=$country");
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php
                             if(isset($_GET['id'])){
                            ?>
                               <input type='radio' id='free' name='radio' value='2' <?php if($radio=='2') echo "checked";?> class='radio'>  
                       <?php
                             }
                             else{
                         ...
                         echo "<input type='radio' id='free' name='radio' value='$ref_id_free' class='radio'>";
                          }
                        }
                        ?>
                        ...
                        if(isset($_GET['id'])){
                            ?>
                           <input type='radio' id='paid' name='radio' value='1' <?php if($radio=='1') echo "checked";?> class='radio'> 
                         <?php  
                        }
                         else{
                         ...
                         echo "<input type='radio' id='paid' name='radio' value='$ref_id_paid' class='radio'>";
                          }
                             }
                        ?>
