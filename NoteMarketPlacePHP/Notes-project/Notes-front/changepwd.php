                    ...
                    <form class="bg-white">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                <input id="password-field" type="password" class="form-control" name="password" placeholder="Enter your old password">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                <input id="password-field-2" type="password" class="form-control" name="password" placeholder="Enter your new password">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                <input id="password-field-3" type="password" class="form-control" name="password" placeholder="Enter your confirm password">
                                <img src="image/pre-login/eye.png" toggle="#password-field-3" class="toggle-password">
                            </div>
                        </div>

                        <button type="submit" class="btn btn-block btn-change-pwd">SUBMIT</button>
